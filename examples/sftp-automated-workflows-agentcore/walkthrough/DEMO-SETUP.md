...
Run the verification script to check your environment (from the walkthrough/scripts folder):
...
When finished with the demo, you have two cleanup options (from the walkthrough/scripts folder):
