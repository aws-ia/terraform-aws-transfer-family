...
echo ""
echo -e "${BLUE}Command:${NC} terraform apply -var-file=stage2.tfvars -auto-approve -compact-warnings"
echo ""
...
terraform -chdir="$SCRIPT_DIR" apply -var-file="stage2.tfvars" -auto-approve -compact-warnings
