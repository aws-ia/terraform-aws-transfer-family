...
class AgentCoreMCPClient:
    ...
    @staticmethod
    def with_gateway_url(gateway_url: str, credentials: Any, region: str, session_id: str) -> MCPClient:
        """Create an MCP client that connects directly to a gateway URL."""
        # Ensure the URL ends with /mcp (the MCP protocol endpoint)
