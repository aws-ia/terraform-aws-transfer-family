"""Fraud Detection Agent — AgentCore Runtime entrypoint."""
...
def invoke(payload, context=None):
    ...
    logger.info("Invoked fraud_detection for claim=%s session=%s", claim_id, session_id)
    ...
    try:
        ...
        logger.exception("fraud_detection invocation failed")
        raise
