...
| <a name="input_create_logging_role"></a> [create\_logging\_role](#input\_create\_logging\_role) | Use custom role (name provided by logging\_role variable) for logging | `bool` | `true` | no |
